...
exports.mockDataTemplate = exports.storiesTemplate = exports.stylesTemplate = exports.typesTemplate = exports.componentTemplate = void 0;
...
const typesTemplate = (componentName) => `interface ${componentName}Props {
...
const stylesTemplate = (componentName) => `import styled from 'styled-components';
...
const storiesTemplate = (componentName) => `import type { Meta, StoryObj } from '@storybook/react';
...
`;
exports.storiesTemplate = storiesTemplate;
const mockDataTemplate = (componentName) => `export default {
...
`;
exports.mockDataTemplate = mockDataTemplate;
